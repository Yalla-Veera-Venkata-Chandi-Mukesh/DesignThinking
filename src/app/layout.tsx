...
export const metadata: Metadata = {
  title: "Group 6 — Design Thinking",
  description: "Protecting Senior Citizens from Digital Scams — A Design Thinking Case Study by Group 6, Mahindra University 2026.",
};
